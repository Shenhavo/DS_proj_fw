...
//    ret |= sensor->snapshot(sensor, NULL, NULL); // Force shadow mode register to update... // TODO: uncomment.. snapshot
    return ret;
}
...
int mt9v034_init(sensor_t *sensor)
{
    ...
    sensor->set_auto_gain       = NULL; // set_auto_gain; // TODO:
    sensor->get_gain_db         = NULL; // get_gain_db; // TODO:
    sensor->set_auto_exposure   = NULL; // set_auto_exposure; // TODO:
